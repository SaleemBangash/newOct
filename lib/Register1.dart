    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 66.0, middle: 0.3927),
            Pin(size: 28.0, middle: 0.2572),
            child: PageLink(
              links: [
                PageLinkInfo(
          ...
          Pinned.fromPins(
            Pin(size: 348.0, end: -9.0),
            Pin(size: 58.0, middle: 0.1671),
            child: Text.rich(
              TextSpan(
                style: TextStyle(
                  fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(start: 53.0, end: 51.5),
            Pin(size: 30.6, middle: 0.5171),
            child: Stack(
              children: <Widget>[
                TextFormField(
                ...
                // ),
                // Pinned.fromPins(
                //   Pin(size: 20.4, start: 1.0),
                //   Pin(start: 5.5, end: 4.6),
                //   child:
          ...
          Pinned.fromPins(
            Pin(start: 53.0, end: 51.0),
            Pin(size: 30.6, middle: 0.3641),
            child: Stack(
              children: <Widget>[
                TextFormField(
                  style: TextStyle(color: Colors.black),
                ...
                // ),
                // Pinned.fromPins(
                //   Pin(size: 18.8, start: 1.5),
                //   Pin(size: 21.1, start: 0.9),
                //   child:
          ...
          Pinned.fromPins(
            Pin(start: 61.0, end: 83.0),
            Pin(size: 45.0, middle: 0.6141),
            child: Component31(),
          ),
        ],
      ),
