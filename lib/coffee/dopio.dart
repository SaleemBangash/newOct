...
class Dopio extends StatelessWidget {
  Dopio({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child:
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/asset-1.png'),
                  fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(start: -71.0, end: -35.0),
            Pin(size: 520.0, start: -14.0),
            child:
                // Adobe XD layer: 'sheri-silver-5A0O12…' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/doppio.jpg'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
