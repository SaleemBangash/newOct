  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 126.0, start: 36.0),
            Pin(size: 36.0, start: 136.0),
            child: Text(
              'Checkout',
              style: TextStyle(
                fontFamily: 'Poppins',
            ...
            child:
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: const AssetImage('assets/images/vanila.jpg'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
          ...
          Pinned.fromPins(
            Pin(size: 149.0, middle: 0.5627),
            Pin(size: 28.0, middle: 0.2383),
            child: Text(
              'Vanilla Flavour',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 86.0, start: 51.0),
            child:
                // Adobe XD layer: 'notification' (component)
                notification(),
          ),
          Pinned.fromPins(
          ...
          Pinned.fromPins(
            Pin(size: 118.0, start: 36.0),
            Pin(size: 28.0, middle: 0.6938),
            child: Text(
              'Time Spane',
              style: TextStyle(
                fontFamily: 'Poppins',
