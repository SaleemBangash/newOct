    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          // ),
          // Pinned.fromPins(
          //   Pin(size: 32.8, middle: 0.7418),
          //   Pin(size: 28.7, end: 19.3),
          //   child: Stack(
          //     children: <Widget>[
          //       Pinned.fromPins(
          //         Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 62.0, start: 53.5),
            Pin(size: 28.0, middle: 0.2071),
            child: Text(
              'Name',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 204.0, start: 53.5),
            Pin(size: 28.0, middle: 0.2984),
            child: Text(
              'Credit card number',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 47.0, middle: 0.6077),
            Pin(size: 28.0, middle: 0.4042),
            child: Text(
              'CVV',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 128.0, start: 53.0),
            Pin(size: 1.0, middle: 0.4589),
            child: TextFormField(
          ...
          // ),
          // Pinned.fromPins(
          //   Pin(size: 184.0, start: 56.5),
          //   Pin(size: 28.0, middle: 0.2428),
          //   child: Text(
          //     'Waleed Bin Khaled',
          //     style: TextStyle(
          //       fontFamily: 'Poppins',
          ...
          // ),
          // Pinned.fromPins(
          //   Pin(size: 245.0, start: 53.5),
          //   Pin(size: 28.0, middle: 0.3341),
          //   child: Text(
          //     '*********************6789',
          //     style: TextStyle(
          //       fontFamily: 'Poppins',
          ...
          // ),
          // Pinned.fromPins(
          //   Pin(size: 58.0, start: 53.5),
          //   Pin(size: 28.0, middle: 0.4399),
          //   child: Text(
          //     '00/00',
          //     style: TextStyle(
          //       fontFamily: 'Poppins',
          ...
          // ),
          // Pinned.fromPins(
          //   Pin(size: 31.0, middle: 0.5832),
          //   Pin(size: 28.0, middle: 0.4354),
          //   child: Text(
          //     '---',
          //     style: TextStyle(
          //       fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
              Pin(size: 95.0, start: 53.5), Pin(size: 38.0, middle: 0.5142),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    transition: LinkTransition.Fade,
                ...
                child: Container(
                  ...
                  child: Pinned.fromPins(
                    Pin(size: 70.0, start: 83.5),
                    Pin(size: 28.0, middle: 0.4442),
                    child: Text(
                      'Save',
                      style: TextStyle(
                        fontFamily: 'Poppins',
...
const String _svg_cuywai =
    '<svg viewBox="53.0 247.5 349.0 1.0" ><path transform="translate(53.02, 247.5)" d="M 0 0 L 349 0" fill="none" stroke="#474747" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_dhrngk =
    '<svg viewBox="53.0 329.5 349.0 1.0" ><path transform="translate(53.02, 329.5)" d="M 0 0 L 349 0" fill="none" stroke="#474747" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_b691g =
    '<svg viewBox="53.0 424.5 128.0 1.0" ><path transform="translate(53.02, 424.5)" d="M 0 0 L 128 0" fill="none" stroke="#474747" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ys5f74 =
    '<svg viewBox="231.5 424.5 101.5 1.0" ><path transform="translate(231.52, 424.5)" d="M 0 0 L 101.5 0" fill="none" stroke="#474747" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
