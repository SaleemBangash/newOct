...
import './payment_reactangle.dart';
import './cash_icon.dart';
import './cotcard.dart';
import './check_icon_green.dart';
import './check_icon_white.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [const Color(0xfffcfaf5), const Color(0xfffcfaf5)],
                  stops: [0.0, 1.0],
                ),
              ),
            ),
          ...
          Pinned.fromPins(
            Pin(size: 238.0, start: 36.0),
            Pin(size: 36.0, start: 121.0),
            child: Text(
              'Payment Methods',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 45.0, end: 121.0),
            child:
                // Adobe XD layer: 'add_payment_button' (component)
                PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => cardinfo(),
                ),
              ],
              child: add_payment_button(),
            ),
          ),
          Pinned.fromPins(
            Pin(start: 36.0, end: 33.0),
            Pin(size: 27.0, middle: 0.1969),
            child: Text(
              'Chose your desired payment method',
              style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 19,
                color: const Color(0xff2a2a2a),
          ...
          Pinned.fromPins(
            Pin(size: 83.6, start: 51.0),
            Pin(size: 52.5, middle: 0.3094),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 83.6, start: 51.0),
            Pin(size: 54.8, middle: 0.4386),
            child:
                // Adobe XD layer: 'visacard' (component)
                visacard(),
          ),
          Pinned.fromPins(
            Pin(start: 36.0, end: 35.0),
            Pin(size: 77.0, middle: 0.6961),
            child:
                // Adobe XD layer: 'payment_reactangle' (component)
                payment_reactangle(),
          ),
          Pinned.fromPins(
            Pin(size: 81.6, start: 45.0),
            Pin(size: 51.3, middle: 0.6905),
            child:
                // Adobe XD layer: 'cash_icon' (component)
                cash_icon(),
          ),
          Pinned.fromPins(
            Pin(size: 135.0, middle: 0.5812),
            Pin(size: 41.0, middle: 0.6881),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 193.0, middle: 0.7123),
            Pin(size: 33.0, middle: 0.3102),
            child: Text(
              '************6678',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 91.0, middle: 0.4926),
            Pin(size: 23.0, middle: 0.3256),
            child: Text(
              'Exp 01/26',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 47.4, start: 62.1),
            Pin(size: 47.4, middle: 0.5677),
            child:
                // Adobe XD layer: 'cotcard' (component)
                cotcard(),
          ),
          Pinned.fromPins(
          ...
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'check_icon_green' (component)
                check_icon_green(),
          ),
          Pinned.fromPins(
            Pin(size: 20.0, end: 45.0),
            Pin(size: 20.0, middle: 0.4669),
            child:
                // Adobe XD layer: 'check_icon_white' (component)
                check_icon_white(),
          ),
          Pinned.fromPins(
            Pin(size: 20.0, end: 45.0),
            Pin(size: 20.0, middle: 0.5916),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
