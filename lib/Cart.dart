  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 127.0, start: 36.0),
            Pin(size: 36.0, start: 88.0),
            child: Text(
              'Your Cart',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 128.0, end: 37.0),
            Pin(size: 43.0, middle: 0.3101),
            child: SvgPicture.string(
              _svg_ouaxz6,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 102.0, end: 50.0),
            Pin(size: 25.0, middle: 0.3141),
            child: Text(
              'Apply code',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          //Vanila Flavour Container
          Pinned.fromPins(
            Pin(start: 36.0, end: 30.0),
            Pin(size: 126.0, middle: 0.5025),
            child: SvgPicture.string(
              _svg_x7d9jt,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          //Container of Swipe Button Container
          Pinned.fromPins(
            Pin(start: 0.0, end: -7.0),
            Pin(size: 97.0, end: 90.0),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 146.0, middle: 0.5709),
            Pin(size: 28.0, middle: 0.4722),
            child: Text(
              'Vanilla Flavour',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(start: 28.0, end: 21.0),
            Pin(size: 74.0, middle: 0.8545),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 90.0, end: 16.0),
                  Pin(size: 31.0, middle: 0.4884),
                  child: Text(
                    'to Order',
                    style: TextStyle(
                      fontFamily: 'Poppins',
