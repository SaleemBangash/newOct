  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 130.0, start: 46.0),
            Pin(size: 36.0, start: 90.0),
            child: Text(
              'Checkout',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 114.0, start: 36.0),
            Pin(size: 28.0, middle: 0.6672),
            child: Text(
              'Time Spane',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 144.0, start: 36.0),
            Pin(size: 28.0, middle: 0.6972),
            child: Text(
              'Extra Toppings ',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
              Pin(size: 31.1, start: 14.0), Pin(size: 29.3, start: 50.0),
              child: PageLink(
                links: [
                  PageLinkInfo(
          ...
          Pinned.fromPins(
            Pin(start: 37.0, end: 28.0),
            Pin(size: 179.9, middle: 0.214),
            child: SvgPicture.string(
              _svg_e8ayrl,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
              Pin(size: 138.0, end: 44.0), Pin(size: 53.0, middle: 0.2553),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ease: Curves.easeInOut,
                    duration: 0.6,
                    pageBuilder: () => adddescription(),
                  ),
                ],
                child: SvgPicture.string(
                  _svg_cyd8l6,
          ...
          Pinned.fromPins(
              Pin(size: 122.0, end: 47.0), Pin(size: 55.0, middle: 0.2562),
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ease: Curves.easeInOut,
          ...
          Pinned.fromPins(
            Pin(size: 128.0, end: 51.0),
            Pin(size: 43.0, middle: 0.3499),
            child: SvgPicture.string(
              _svg_urncje,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 155.0, middle: 0.6925),
            Pin(size: 28.0, middle: 0.2038),
            child: Text(
              'Vanilla Flavour',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 70.0, middle: 0.4997),
            Pin(size: 25.0, middle: 0.2497),
            child: Text(
              'Small',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 82.0, middle: 0.7811),
            Pin(size: 28.0, middle: 0.353),
            child: Text(
              'Remove',
              style: TextStyle(
                fontFamily: 'Poppins',
          ...
          Pinned.fromPins(
            Pin(size: 31.0, middle: 0.3239),
            Pin(size: 31.0, middle: 0.3553),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            ...
            child:
                // Adobe XD layer: 'pickup_place' (component)
                PageLink(
              links: [
                PageLinkInfo(
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                //Place order Buton
                Pinned.fromPins(Pin(size: 119.0, middle: 0.5),
